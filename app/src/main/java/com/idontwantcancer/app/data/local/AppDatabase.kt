...
abstract class AppDatabase : RoomDatabase() {
    ...
    abstract fun educationLessonDao(): EducationLessonDao
    abstract fun preventionActionDao(): PreventionActionDao
    ...
    abstract fun redFlagDirectiveDao(): RedFlagDirectiveDao
