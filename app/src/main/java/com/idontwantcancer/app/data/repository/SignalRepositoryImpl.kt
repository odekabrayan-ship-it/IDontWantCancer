...
class SignalRepositoryImpl @Inject constructor(
    ...
    override suspend fun updateWatchStatus(signalId: String, isWatched: Boolean) = withContext(dispatcherProvider.io) {
        signalDao.updateWatchStatus(signalId, isWatched)
    }
}
