...
object DatabaseModule {
    ...
    fun provideDatabase(@ApplicationContext context: Context): AppDatabase {
        ...
        val migration23To24 = object : Migration(23, 24) {
            override fun migrate(db: SupportSQLiteDatabase) {
                db.execSQL(
                    "ALTER TABLE `signals` ADD COLUMN `isWatched` INTEGER NOT NULL DEFAULT 0"
                )
            }
        }
        ...
        val migration25To26 = object : Migration(25, 26) {
            override fun migrate(db: SupportSQLiteDatabase) {
                db.execSQL(
                    "ALTER TABLE `nutrition_intelligence` ADD COLUMN `category` TEXT NOT NULL DEFAULT 'PATTERN'"
                )
            }
        }
        ...
        val migration28To29 = object : Migration(28, 29) {
            override fun migrate(db: SupportSQLiteDatabase) {
                db.execSQL(
                    "CREATE TABLE IF NOT EXISTS `patient_truth_checks` (`id` TEXT NOT NULL, `claim` TEXT NOT NULL, `verdict` TEXT NOT NULL, `theTruth` TEXT NOT NULL, `theCommand` TEXT NOT NULL, `theExecutionJson` TEXT NOT NULL, `theShield` TEXT NOT NULL, `socialScript` TEXT NOT NULL, PRIMARY KEY(`id`))"
                )
            }
        }
        ...
        val migration29To30 = object : Migration(29, 30) {
            override fun migrate(db: SupportSQLiteDatabase) {
                db.execSQL(
                    "CREATE TABLE IF NOT EXISTS `healing_log` (`id` TEXT NOT NULL, `directiveId` TEXT NOT NULL, `directiveName` TEXT NOT NULL, `timestamp` INTEGER NOT NULL, `type` TEXT NOT NULL, PRIMARY KEY(`id`))"
                )
            }
        }
        ...
        val migration30To31 = object : Migration(30, 31) {
            override fun migrate(db: SupportSQLiteDatabase) {
                db.execSQL(
                    "ALTER TABLE `signals` ADD COLUMN `interactionContextsJson` TEXT NOT NULL DEFAULT '[]'"
                )
            }
        }
        ...
        val migration32To33 = object : Migration(32, 33) {
            override fun migrate(db: SupportSQLiteDatabase) {
                db.execSQL(
                    "ALTER TABLE `nutrition_intelligence` ADD COLUMN `switchThisForThat` TEXT"
                )
            }
        }
        ...
        val migration33To34 = object : Migration(33, 34) {
            override fun migrate(db: SupportSQLiteDatabase) {
                db.execSQL(
                    "ALTER TABLE `signals` ADD COLUMN `discoveryTagsJson` TEXT NOT NULL DEFAULT '[]'"
                )
            }
        }
        ...
        val migration34To35 = object : Migration(34, 35) {
            override fun migrate(db: SupportSQLiteDatabase) {
                db.execSQL(
                    "ALTER TABLE `education_lessons` ADD COLUMN `isRead` INTEGER NOT NULL DEFAULT 0"
                )
            }
        }
